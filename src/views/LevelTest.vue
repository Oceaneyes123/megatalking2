<template>
  <v-app style="background-color:#00000000">
    ...
    <v-dialog
      v-model="termsDialog"
      max-width="1000"
      style="overflow-x:hidden;border-radius: 25px 25px 25px 25px !important"
    >
          ...
          <v-container class="py-0">
            <v-row>
              ...
              <v-col cols="6" class="d-flex justify-end" >
                <v-icon color="white" large @click="termsDialog = false">close</v-icon>
              </v-col>
            </v-row>
          </v-container>
        </v-card>
        <v-card>
          <v-container>
            <v-row>
              ...
              >
              1. 개인정보는 생존하는 개인에 관한 정보로서 실명, 전화번호 등의 사항으로 당사 회원 개인을 식별할 수 있는 정보(당해 정보만으로는 특정 개인을 식별할 수 없더라도 다른 정보와 용이하게 결합하여 식별할 수 있는 것을 포함)를 말합니다. 당사가 수집한 개인정보는 다음의 목적을 위해 활용합니다
              서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산, 콘텐츠 제공, 물품배송 또는 청구서 등 발송, 금융거래 본인 인증 및 금융 서비스, 구매 및 요금 결제, 요금추심, 회원 관리, 회원제 서비스 이용에 따른 본인확인, 개인식별, 불량회원의 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인, 가입 및 가입횟수 제한, 만14세 미만 아동 개인 정보 수집 시 법정 대리인 동의 여부 확인, 추후 법정 대리인 본인확인, 분쟁 조정을 위한 기록보존, 불만처리 등 민원처리,고지사항 전달.
              마케팅 및 광고에 활용 - 신규 서비스(제품) 개발 및 특화, 인구통계학적 특성에 따른 서비스 제공 및 광고게재, 접속 빈도 파악, 회원의 서비스 이용에 대한 통계, 이벤트 등 광고성 정보 전달 (회원님의 개인정보는 광고를 의뢰한 개인이나 단체에는 제공되지 않습니다.)
              <br><br>

              2. 수집개인정보 항목 및 수집방법
              회사는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
              ① 최초 회원가입 시 수집항목: 이름, 아이디(보안을 위하여 강력한 암호 알고리즘으로 암호화 되어 저장됨), 비밀번호, 자택 전화번호, 자택 주소, 휴대전화번호, 이메일, 수업이름
              ② 서비스 이용과정이나 사업처리 과정에서 자동으로 생성되어 수집될 수 있는 항목: 접속 IP, 쿠키, 결제기록, 접속로그, 서비스이용기록, 불량 이용기록, 상담기록
              ③ 개인정보 수집방법 : 홈페이지, 서면양식, 팩스, 전화, 상담 게시판, 이메일, 이벤트 응모, 배송요청, 협력회사로부터의 제공, 생성정보 수집 툴을 통한 수집
<br><br>
              3. 개인정보 보유 및 이용기간
            ...
            <br><br>
              ...
              5. 개인정보 제공 및 공유
              회사는 원칙적으로 회원님의 개인정보를 수집 및 이용목적에 한해서만 이용하며 타인 또는 타 기업 기관에 공개하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
              ① 이용자들이 사전에 동의한 경우
...
<br><br>
              ...
              ③	이용자의 개인정보 조회, 수정을 위해서는 회사 홈에 있는 “정보수정”을, 가입해지 시에는 “회원탈퇴”를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다. 혹은 개인정보관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체 없이 조치하겠습니다.
              ...
              ⑤	회사는 이용자 혹은 법정대리인의 요청에 의해 해지 또는 삭제된 개인정보는 “3. 개인정보의 보유 및 이용기간”에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.
<br><br>
              8. 개인정보 자동수집장치의 설치 및 거부
              회사는 귀하의 정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다. 회사는 다음과 같은 목적을 위해 쿠키를 사용합니다.
              ① 쿠키의 목적
...
<br><br>
              9. 개인정보 관리책임자 및 상담신고
              회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 개인정보관리책임자를 지정하고 있습니다. 고객의 개인정보와 관련한 문의사항이 있으시면 아래의 개인정보 관리책임자에게 연락 주시기 바랍니다.
<br><br>
              [개인정보 관리책임자]
              ㆍ성명 : 이현석
              ㆍ소속 : (주)유에듀케이션
              ...
              * URL: http://www.ctrc.go.kr/
              11. 기타
              회사 사이트에 링크되어 있는 웹사이트들이 개인정보를 수집하는 행위에 대해서는 본 "개인정보취급방침"이 적용되지 않음을 알려 드립니다. 또한 회사가 포함하고 있는 링크를 통해 타 사이트 방문 시, 해당 사이트의 개인정보 취급방침은 무관하므로, 새로운 사이트의 개인정보 취급방침을 확인하시기 바랍니다.
              12. 고지의 의무
