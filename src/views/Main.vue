            ...
            <v-container class="px-0 py-0">
              <v-row no-gutters>
                <v-col cols="12" sm="6" class="pl-10 px-md-5 py-5">
                  <div class="mr-5">
                    <div
                      class="h4 font-weight-bold mb-7"
                      style="color: #70689f"
                    >
                      35,000개
                      <br />품격있는 컨텐츠
      ...
      koreanTextBlue: [
        {
          title: "다양한 주제로!",
          text:
            "- 무비, 셀럽 인터뷰, TED, 최신Pop, 패션등 다양한 주제로 수업해보세요.",
        },
        {
          title: "친구같은 강사님과 매일 1:1 수업",
          text:
            "- 외국인 강사님과 더 생생하고 편한한 분위기로 수업합니다. <br> - 프리토킹 클래스로 영어 실력을 쌓아보세요.",
        },
        {
          title: "스피킹 실력=말하기 시간! ",
        ...
        },
        {
          title: "실시간, 쌍방향 소통 ",
          text:
            "- 다양한 주제로 친구 같은 강사님과 매일 “영어수다”를 나눠보세요.",
        },
        {
          title: "내 시간은 소중하니깐.",
          text:
