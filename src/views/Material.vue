            ...
            <v-container>
              <v-row justify="space-between" class="px-5">
                <div class="d-flex flex-column mx-auto">
                  <v-icon color="white" x-large>far fa-user</v-icon>
                  <div class="mt-3">마이페이지</div>
                </div>
                <v-divider vertical></v-divider>
                <div class="d-flex flex-column mx-auto">
                  <v-icon color="white" x-large>far fa-bell</v-icon>
                ...
                <v-divider vertical></v-divider>
                <div class="d-flex flex-column mx-auto">
                  <v-icon color="white" x-large>fas fa-book-open</v-icon>
                  <div class="mt-3">교재</div>
                </div>
                <v-divider vertical></v-divider>
                <div class="d-flex flex-column mx-auto">
                  <v-icon color="white" x-large>fas fa-ticket-alt</v-icon>
