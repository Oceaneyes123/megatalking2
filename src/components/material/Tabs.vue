              ...
              <v-row>
                <v-col>
                  <div class="text--secondary">
                    A model or actress, I would say should always have something
                    to keep them entertained in their bag
                  </div>
                  <div>
                    모델이나 여배우라면, 항상 가방에 즐겁게 해줄 무언가가
                    있어야한다고 말하고 싶습니다.
                  </div>
                </v-col>
              </v-row>
              <v-row>
                <v-col>
                  ...
                  <div class="ml-8 text--secondary mb-10">
                    I would say = I’ d say 는 확실하지 않을때 자신의 의견을
                    말하는 경우 사용하는 표현이예요. 내생각엔… 이라는 뜻으로
                    해석할 수 있어요. 확실하지 않은 생각이나 의견 표현에
                    쓰입니다.
                  </div>
                  ...
                  <div class="ml-8 mb-10">
                    ...
                    <div class="text--secondary">
                      그거 좋은 아이디어라고 할 수 있겠네. (내 생각엔 그거 좋은
                      아이디어인것 같아.)
                    </div>
                  </div>
                  ...
                  <div class="ml-8">
                    ...
                    <div class="text--secondary">
                      내가 널 그리워한다고 할 수 있겠어. (내 생각엔 내가 널
                      그리워하는 것 같아)
                    </div>
                  </div>
