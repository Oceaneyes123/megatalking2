    ...
    return {
      ...
      classReview: [
        ...
        },
        {
          title: "메가토킹 완전 좋네여",
          content:
            "올해 2월 전화영어란걸 알게되서, 비교해보려고 몇군데서 전화영어를 하고있는데 메가토킹 진짜 좋네요... <br><br>선생님이 대화를 굉장히 잘 이끌어주시네요. 틀리면 고쳐서 바로 말해주셔서 정확한 표현을 배울 수 있고, 단어도 다양하게 사용해주셔서 공부가 많이 됩니다.<br><br>부담없이 꽉 찬 수업 했다는 느낌을 받았고<br><br>피드백도 다른데는 늘 똑같은 말만 써있어서 아쉬웠는데.. 메가토킹은 피드백도 다르네요. 잘못된 표현과 발음을 제대로 정검하고 고칠 수 있고 더 공부할 수 있어서 유익하네요..<br><br> 미란다 선생님, 좋은 수업 감사합니다",
          from: "Hyewon"
        },
        {
