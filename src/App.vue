<template>
  <div id="app">
    <v-app>
      ...
      >
        <v-container class="d-flex flex-row">
          ...
          >
            ...
            <div class="mr-6 subheading" @click="$router.push('/enrollment')">
              수강신청
            </div>
            <div class="mr-8 subheading">마이페이지</div>
      ...
      <v-card
        style="position:absolute;bottom:0;width:100%; left:50%;transform:translateX(-50%)"
        max-width="1000"
        class="mx-auto"
        color="#00000000"
        flat
