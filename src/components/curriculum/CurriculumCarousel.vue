            ...
            <v-col class="py-0 d-flex justify-center" cols="12" md="5">
              ...
              >
                ...
                <v-card
                  ...
                  color="#fafafa"
                  width="80%"
                  class="subtitle-text-1 black--text mx-auto text-center font-weight-black mt-3"
                  >{{ book.title }}</v-card
                >
                <v-card
                  flat
            ...
            <v-col cols="12" md="7">
              <v-container fluid>
                <v-row class="h6 font-weight-bold" justify="center">
                  <div class="text-center black--text">학습교재</div>
                </v-row>
                <v-row>
                  <v-col cols="6">
                    <v-img
                  ...
                  <v-col cols="6" class="d-flex align-end">
                    <div class="d-flex flex-column align-start">
                      ...
                      >
                      <div
                        class="h5 nanum black--text text-left"
